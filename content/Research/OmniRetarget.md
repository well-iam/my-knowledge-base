...
## Research Gap
Nessun metodo esistente preserva esplicitamente le relazioni spaziali/di contatto (corpo-oggetto-terreno) durante il retargeting *mentre* applica vincoli fisici hard (non solo soft penalty). L'unico lavoro concettualmente vicino (IMMA, 2012) preserva relazioni spaziali tra parti del corpo ma non è open-source, ignora limiti cinematici e non considera oggetti/ambiente. Inoltre, generare varianti dello stesso task (oggetti/terreni diversi) richiede oggi nuove demo da zero — costoso, non scalabile.
